...
public class Leaderboard {
    ...
    public int getWins(Player player) {
        return getWins(player.getServerId());
    }
    ...
    public void addStat(Player player, Stats stat, int amount) {
        addStat(player.getServerId(), stat, amount);
    }
    ...
    public int getStat(Player player, Stats stat) {
        return getStat(player.getServerId(), stat);
    }
    ...
    private void loadLeaderboard() {
        leaderboardConfig = new Config(HG.getInstance().getDataFolder()+"/leaderboard.yml", Config.YAML);
    ...
    private void sortScores(Map<String, Integer> map, List<String> scores, List<String> players) {
        ...
        for (Map.Entry<String, Integer> sortingMap : entriesSortedByValues(map)) {
            String player = HG.getInstance().getServer().getOfflinePlayer(UUID.fromString(sortingMap.getKey())).getName();
