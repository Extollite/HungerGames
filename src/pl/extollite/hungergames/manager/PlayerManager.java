...
public class PlayerManager {
    ...
    public boolean hasPlayerData(Player player) {
        return hasPlayerData(player.getServerId());
    }
    ...
    public boolean hasSpectatorData(Player player) {
        return hasSpectatorData(player.getServerId());
    }
    ...
    public PlayerData getPlayerData(Player player) {
        return getPlayerData(player.getServerId());
    }
    ...
    public PlayerData getSpectatorData(Player player) {
        return getSpectatorData(player.getServerId());
    }
    ...
    public PlayerData getData(Player player) {
        return getData(player.getServerId());
    }
    ...
    public boolean hasData(Player player) {
        return hasData(player.getServerId());
    }
    ...
    public void addPlayerData(PlayerData playerData) {
        playerMap.put(playerData.getPlayer().getServerId(), playerData);
    }
    ...
    public void addSpectatorData(PlayerData playerData) {
        this.spectatorMap.put(playerData.getPlayer().getServerId(), playerData);
    }
    ...
    public void removePlayerData(Player player) {
        this.playerMap.remove(player.getServerId());
    }
    ...
    public void removeSpectatorData(Player player) {
        this.spectatorMap.remove(player.getServerId());
    }
    ...
    public Game getGame(Player player) {
        return getGame(player.getServerId());
    }
